...
void NemhauserUllmannRLPParallelSolver::setUp() {
	initPlotPointLists();
 ...
 */
int ESTIMATED_MAX_NUMBER_OF_POINTS_RLP_PARALLEL = 100000;

void NemhauserUllmannRLPParallelSolver::initPlotPointLists() {
...
void NemhauserUllmannRLPParallelSolver::sortInputItems() {
...
void NemhauserUllmannRLPParallelSolver::tearDown() {
	deletePlotPointLists();
}
void NemhauserUllmannRLPParallelSolver::deletePlotPointLists() {
	for (int i=0; i < ESTIMATED_MAX_NUMBER_OF_POINTS_RLP_PARALLEL ;++i) {
...
bool NemhauserUllmannRLPParallelSolver::betterPointExists(PlotPoint* ptToCheck, PlotPoint* list, int counter) {
...
int NemhauserUllmannRLPParallelSolver::removeHopelessPoints(PlotPoint* list, int counter, const int& remainingWorthOfInputItems) {
...
bool NemhauserUllmannRLPParallelSolver::copyPlotPointIfItFitsIntoKnapsack(PlotPoint* from, PlotPoint* to) {
